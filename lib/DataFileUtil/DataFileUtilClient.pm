...
# Authentication: required
    if ((my $n = @args) != 1) {
        Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
                                   "Invalid argument count for function shock_to_file_mass_async (received $n, expecting 1)");
    }
    {
        my($params) = @args;
        my @_bad_arguments;
...
# Authentication: required
    if ((my $n = @args) != 1) {
        Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
                                   "Invalid argument count for function package_for_download_async (received $n, expecting 1)");
    }
    {
        my($params) = @args;
        my @_bad_arguments;
...
# Authentication: required
    if ((my $n = @args) != 1) {
        Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
                                   "Invalid argument count for function file_to_shock_mass_async (received $n, expecting 1)");
    }
    {
        my($params) = @args;
        my @_bad_arguments;
...
# Authentication: required
    if ((my $n = @args) != 1) {
        Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
                                   "Invalid argument count for function own_shock_node_async (received $n, expecting 1)");
    }
    {
        my($params) = @args;
        my @_bad_arguments;
...
# Authentication: required
    if ((my $n = @args) != 1) {
        Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
                                   "Invalid argument count for function ws_name_to_id_async (received $n, expecting 1)");
    }
    {
        my($name) = @args;
        my @_bad_arguments;
...
# Authentication: required
    if ((my $n = @args) != 1) {
        Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
                                   "Invalid argument count for function save_objects_async (received $n, expecting 1)");
    }
    {
        my($params) = @args;
        my @_bad_arguments;
...
# Authentication: required
    if ((my $n = @args) != 1) {
        Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
                                   "Invalid argument count for function get_objects_async (received $n, expecting 1)");
    }
    {
        my($params) = @args;
        my @_bad_arguments;
