...
public class PhenotypeSetObjectSelection {
    ...
    public PhenotypeSetObjectSelection withPhenotypeName(String phenotypeName) {
        this.phenotypeName = phenotypeName;
        return this;
    }
    ...
    public String toString() {
        return ((((((("PhenotypeSetObjectSelection"+" [workspaceName=")+ workspaceName)+", phenotypeName=")+ phenotypeName)+", additionalProperties=")+ additionalProperties)+"]");
    }
